...
export function HomePage() {
  ...
  return (
    <main className="flex flex-col min-h-[100dvh] gap-y-10">
      <Hero />
      <section id="about">
        <h2 className="text-xl font-semibold w-min">About</h2>
          ...
          <div className="flex flex-col items-center justify-center gap-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                I&apos;ve worked on a variety of projects, from websites
                to scalable backend systems for AI agents. Here are a few of my favorites.
              </p>
            </div>
          </div>
